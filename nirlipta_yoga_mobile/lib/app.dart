  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // Splash View
        '/landing': (context) => const OnboardingScreenView(),
        // Onboarding
        '/login': (context) => const LoginScreenView(),
        // Login View
        '/register': (context) => const RegisterScreenView(),
        // Register View
        '/request-password': (context) => const RequestPasswordScreenView(),
        // Request Password
        '/verify-otp': (context) => const VerifyOtpScreenView(),
        // Verify OTP
        '/reset-password': (context) => const ResetPasswordScreenView(),
        // Reset Password
        '/student-dashboard': (context) => const StudentDashboardScreenView(),
        // Student Dashboard
      },
    );
  }
